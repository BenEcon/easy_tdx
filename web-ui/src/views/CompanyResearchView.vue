...
<template>
  <div class="company-page">
    <section class="query-card">
      ...
      <button class="primary query-btn" :disabled="loading" @click="load">
    ...
    <section v-else-if="tab === 'f10'" class="f10-workspace">
      ...
      <article class="f10-content">
        <header><div><h3>{{ selectedCategory?.name ?? 'F10 公司资料' }}</h3><p>通达信公司资料原文</p></div><span>F10</span></header>
        <pre v-if="companyContent">{{ companyContent }}</pre>
